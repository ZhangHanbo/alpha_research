...
> **Status 2026-04-05** — Architecture revised. The initial T1-T10 implementation (494 tests passing) built the research and review agents from scratch as Python classes backed by tool modules. The project has since adopted a **skills-first architecture** that depends on [`alpha_review`](../../../alpha_review) and expresses domain knowledge as Claude Code `SKILL.md` files rather than Python prompt code. For the current architecture see [`../architecture/tools_and_skills.md`](../architecture/tools_and_skills.md); for the refactor plan from T1-T10 to the new layout see [`../history/refactor_plan.md`](../history/refactor_plan.md) and [`../history/TASKS.md`](../history/TASKS.md) (now R0-R9). For the active integrated state-machine plan see [`./implementation_plan.md`](./implementation_plan.md).
>
