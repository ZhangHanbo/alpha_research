...
- `guidelines/research_guideline.md` — Appendix B rubric, §5.2 process
...
- `guidelines/research_guideline.md` §2.4 — empirical diagnosis
...
- `guidelines/research_guideline.md` §2.7 — challenge → approach table
...
- `guidelines/research_guideline.md` §2.7 — challenge → method class table
- `guidelines/research_plan.md` APPROACH stage inner layer
```
...
- `guidelines/research_guideline.md` — the research lifecycle
- `guidelines/review_guideline.md` — adversarial review companion
- `guidelines/research_plan.md` — state-machine architecture
